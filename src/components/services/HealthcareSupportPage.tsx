  ...
  return (
    <div className="healthcare-page initiative-banner-page">
      ...
      <InitiativeApproachSection
        headingId="healthcare-approach-title"
        image="/elderly_care.png"
      ...
      >
        ...
        <p>
          Our healthcare initiatives focus on bringing essential support closer
          to communities through awareness programmes, health camps, preventive
          care and guidance.
        </p>
        <p>
          We believe better health begins with access to the right information,
          timely support and compassionate care.
        </p>
